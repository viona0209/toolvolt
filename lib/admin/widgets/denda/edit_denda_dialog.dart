...
class EditDendaDialog extends StatelessWidget {
  final int id;
  final String namaLama;
  final int biayaLama;
  final Function(int, String, int) onEdit;

  const EditDendaDialog({
    super.key,
    required this.id,
    required this.namaLama,
    required this.biayaLama,
  ...
  Widget build(BuildContext context) {
    ...
    final biayaController = TextEditingController(text: biayaLama.toString());
